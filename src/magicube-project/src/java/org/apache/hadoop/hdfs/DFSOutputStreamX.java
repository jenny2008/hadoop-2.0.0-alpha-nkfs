...
public class DFSOutputStreamX extends FSOutputSummer implements Syncable {
  ...
  private DFSOutputStreamX(DFSClient dfsClient, String src, long blockSize, Progressable progress,
  ...
  private DFSOutputStreamX(DFSClient dfsClient, String src, FsPermission masked,
  ...
  static DFSOutputStreamX newStreamForCreate(DFSClient dfsClient, String src,
      FsPermission masked, EnumSet<CreateFlag> flag, boolean createParent,
      short replication, long blockSize, Progressable progress, int buffersize,
      DataChecksum checksum) throws IOException {
    final DFSOutputStreamX out = new DFSOutputStreamX(dfsClient, src, masked,
  ...
  private DFSOutputStreamX(DFSClient dfsClient, String src, int buffersize, Progressable progress,
  ...
  static DFSOutputStreamX newStreamForAppend(DFSClient dfsClient, String src,
      int buffersize, Progressable progress, LocatedBlock lastBlock,
      HdfsFileStatus stat, DataChecksum checksum) throws IOException {
    final DFSOutputStreamX out = new DFSOutputStreamX(dfsClient, src, buffersize,
